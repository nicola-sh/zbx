...
window.form = new (class {
  ...
  refreshHostAccordion() {
    ...
    if (ordered.length === 0) {
      ...
      empty.className = "main-overview-per-host-empty";
  ...
  createPerHostAccordion(hostid, profile, L) {
    ...
    root.className = "main-overview-phost js-per-host-block";
    ...
    title.className = "main-overview-phost-title";
  ...
  buildPerHostSection(titleText, inner) {
    ...
    h.type = "button";
    h.className = "main-overview-phost-section-head";
    ...
    t.className = "main-overview-phost-section-title";
  ...
  buildDisplayBadges(hostid, profile) {
    ...
    bpWrap.className = "main-overview-phost-row";
  ...
  buildSwapSection(hostid, profile) {
    ...
    inv.className = "main-overview-phost-row";
    const cb = document.createElement("input");
  ...
  buildInterfacesSection(hostid, profile) {
    ...
    wrap.className = "main-overview-phost-row";
  ...
  makeLabeledRow(labelText, control) {
    ...
    row.className = "main-overview-phost-row";
  ...
  makeInlineLabel(text) {
    ...
    span.className = "main-overview-phost-label";
  ...
  makeItemAssistantRow(label, fieldName, metricValue, value) {
    ...
    row.className = "main-overview-phost-row main-overview-phost-row--stack";
