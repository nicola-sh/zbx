...
class MainOverviewSparkline {

  static ACTION = 'widget.main_overview.sparkline';
  ...
  async _fetchSparklineData(spec, period, signal) {
    ...
    curl.setArgument('action', MainOverviewSparkline.ACTION);
  ...
  _getOverlayRoot() {
    return (typeof this.options.getOverlayRoot === 'function'
      ...
      : null) || this._getBody()?.querySelector('[data-main-overview-role="sparkline"]');
  }

  _getOverviewRoot() {
    return (typeof this.options.getOverviewRoot === 'function'
      ? this.options.getOverviewRoot()
      : null) || this._getBody()?.querySelector('[data-main-overview-role="overview"]');
  }
